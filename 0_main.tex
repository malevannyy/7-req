...
\begin{document}
    ...
    \input{2_the_goal}                                  % Цель работы
    \input{3_chap1}                                     % 1 Предметная область
    \input{4_chap2}                                     % 2 Ход работы
    \input{5_chap3}                                     % 3 Результаты
    \input{6_chap4}                                     % Выводы
